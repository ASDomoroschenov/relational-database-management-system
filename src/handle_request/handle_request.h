...
#include "logger_json_builder_concrete.h"
...
public:
    ...
    static std::string delete_spaces(
            const std::string &str);

    static std::vector<std::string> split_by_spaces(
            const std::string &str);
...
public:
    ...
    static type_data_base *allocate_data_base(
            TREE tree = TREE::RED_BLACK_TREE);

    static type_pool *allocate_pool(
            TREE tree = TREE::RED_BLACK_TREE);

    static type_scheme *allocate_scheme(
            TREE tree = TREE::RED_BLACK_TREE);

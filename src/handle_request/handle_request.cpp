...
type_data_base *handler::allocate_data_base(
        TREE tree)
{
    switch (tree)
    {
...
type_pool *handler::allocate_pool(
        TREE tree)
{
    switch (tree)
    {
...
type_scheme *handler::allocate_scheme(
        TREE tree)
{
    switch (tree)
    {
...
void handler::set_next(
        handler *next_handler)
{
    _next_handler = next_handler;
}

void handler::accept_request(
...
//begin region string processing

std::string handler::delete_spaces(
...
std::vector<std::string> handler::split_by_spaces(
        const std::string &str)
{
